      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-6 relative">
          <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-slate-200/80 group">
            <img
              src=""
              alt="AD Future Stack Team Collaboration"
          ...
          {/* Floating Stat Card */}
          <div className="absolute -bottom-6 -right-4 sm:bottom-8 sm:-right-6 bg-slate-900 text-white rounded-2xl p-6 shadow-2xl border border-slate-800 hidden sm:block">
            <div className="flex items-center gap-4">
              ...
              <div>
                <span className="text-3xl font-semibold text-white block leading-none">100%</span>
                <span className="text-[11px] font-mono font-bold uppercase tracking-wider text-slate-400 mt-1 block">
                  Quality & Precision
                </span>
              </div>
            </div>
        ...
        <div className="lg:col-span-6 space-y-7">
          ...
          {/* Main Title */}
          <h2 className="text-3xl sm:text-4xl font-semibold text-slate-900 tracking-tight leading-[1.15] uppercase">
          ...
          {/* CTA Button (Violet Button Only) */}
          <div className="pt-4">
            <Link
              to="/about"
              className="group inline-flex items-center justify-center gap-3 bg-violet-700 text-white font-extrabold text-xs uppercase tracking-widest px-9 py-4 rounded-xl hover:bg-violet-700 transition-all duration-300 shadow-lg hover:shadow-violet-700/30 active:scale-95 cursor-pointer"
            >
