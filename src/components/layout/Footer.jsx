        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a href="https://github.com" target="_blank" rel="noreferrer" className="h-9 w-9 flex items-center justify-center rounded-lg bg-slate-900 border border-slate-800 text-slate-400 hover:text-cyan-400 hover:border-slate-700 transition-all">
                <Code2 className="h-4 w-4" />
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="h-9 w-9 flex items-center justify-center rounded-lg bg-slate-900 border border-slate-800 text-slate-400 hover:text-cyan-400 hover:border-slate-700 transition-all">
                <Globe className="h-4 w-4" />
              </a>
              <a href="https://twitter.com" target="_blank" rel="noreferrer" className="h-9 w-9 flex items-center justify-center rounded-lg bg-slate-900 border border-slate-800 text-slate-400 hover:text-cyan-400 hover:border-slate-700 transition-all">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><Link to="/capabilities" className="hover:text-cyan-400 transition-colors">Capabilities</Link></li>
              <li><Link to="/solutions" className="hover:text-cyan-400 transition-colors">Solutions</Link></li>
              <li><Link to="/projects" className="hover:text-cyan-400 transition-colors">Case Studies</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><Link to="/services" className="hover:text-cyan-400 transition-colors">Product Engineering</Link></li>
              <li><Link to="/capabilities" className="hover:text-cyan-400 transition-colors">Cloud & DevOps</Link></li>
              <li><Link to="/solutions" className="hover:text-cyan-400 transition-colors">AI & RAG Workflows</Link></li>
              <li><Link to="/about" className="hover:text-cyan-400 transition-colors">About Our Team</Link></li>
              <li><Link to="/contact" className="hover:text-cyan-400 transition-colors">Consultation</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2.5">
                ...
                <a href={`mailto:${CONTACT_EMAIL}`} className="hover:text-cyan-400 transition-colors">{CONTACT_EMAIL}</a>
              </li>
              <li className="flex items-center gap-2.5">
